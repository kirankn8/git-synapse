...
It covers **71,430 commits and 34,810 prompts** from six public projects.

<p align="center">
  <img src="docs/benchmark-hit-rate.svg" alt="Top-five hit rate: free baseline versus Git Synapse across six OSS projects" width="100%">
</p>
...
|---|---:|---:|---:|---:|---:|---:|---:|
| [google/guava](https://github.com/google/guava) | 5,235 | **75.6%** | 55.3% | 54.7% | 51.2% | 50.3% | 40.5% |
...
| [prometheus/prometheus](https://github.com/prometheus/prometheus) | 7,717 | 51.8% | **64.7%** | 62.0% | 57.3% | 53.7% | 32.8% |
| [tokio-rs/tokio](https://github.com/tokio-rs/tokio) | 2,553 | 38.0% | **45.0%** | 41.6% | 36.5% | 33.2% | 26.7% |
| [vuejs/core](https://github.com/vuejs/core) | 5,670 | 57.5% | **61.4%** | 56.4% | 51.4% | 48.2% | 35.6% |

Weighted top-5 hit rates are: free baseline **48.0%**, `P(B|A)` **57.5%**,

      ...
      card(
        ...
        dataTable(
          ...
          [
            ...
            { key: 'n_b', label: 'Its total', num: true, title: "The partner's own change count" },
            ...
            { key: state.measure, label: spec ? spec.label : state.measure, num: true, render: (p) => scoreCell(p[state.measure], spec) },
          ],
          {
            initialSort: state.measure,
  ...
  return dataTable(
    ...
    [
      ...
      { key: 'flags', label: 'Notes', sortable: false, render: (m) => h('div', { class: 'pillrow' },
          m.recommended ? h('span', { class: 'badge ok' }, 'recommended') : null,
    ...
    card(
      ...
      dataTable(
        ...
        [
          ...
          { key: 'confidence_ab', label: 'P(B|A)', num: true, render: (d) => pct(d.confidence_ab) },
          { key: state.measure, label: spec ? spec.label : state.measure, num: true, render: (d) => scoreCell(d[state.measure], spec) },
        ],
        { initialSort: state.measure, onRow: (d) => go(`/dir/${d.other_id}`), empty: 'No coupled directories.' },
      ),
    ),
  );
  return wrap;
